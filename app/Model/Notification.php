...
class Notification extends AppModel
{
    ...
    public function beforeSave($options = array()) {
        if(!empty($this->data['Notification']['file_name']))
        {
            if ( empty($this->data['Notification']['file_name']["name"]) )
                return $this->data['Notification']['file_name'] = null;
            ...
            $this->data['Notification']['file_name'] = $this->upload($this->data['Notification']['file_name'], "uploads/customers/" . $dir_customer);
    ...
    {
        $image_name = strtolower(Inflector::slug($image_name,'-')); // Trata o nome removendo espaços, acentos e caracteres em maiúsculo.
