	...
	<div class="container-fluid">
		<div class="row bg-title">
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h4 class="page-title">Imagem de Perfil</h4>
			</div>
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					<li><a href="/admin/dashboard">Painel de Controle</a></li>
					<li><a href="#">Perfil</a></li>
					<li class="active">Imagem de Perfil</li>
				</ol>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="white-box">
					...
					<h3 class="box-title m-b-0 text-center">Imagem de Perfil</h3>
							...
							<div class="white-box">
								<div class="row">
									...
									<div class="col-md-9 p-20">
										<div class="img-container"><img id="image" src="<?php echo ( !empty( AuthComponent::user('avatar') ) ? '/uploads/anuncio/avatar/' . AuthComponent::user('id') . '/' . AuthComponent::user('avatar') : '/plugins/images/users/capaprofile.jpg' ) ?>" class="img-responsive"  alt="Picture"></div>
									</div>
					...
					$(function () {
						...
						{
							// var imgData = JSON.stringify( $('#download').attr('href') );
							...
							var formData =
							{
								...
								{
									"img" 			: imgData,
									"relative_path" : 'uploads/anuncio/avatar'
								}
							}
							...
							$.ajax({
								...
								success: function(result)
								{
									if ( result.status )
									{
										...
										$('a > img.img-circle').attr('src',imgData);
									}
									else
									{
										//$('.preloader').hide(); // hidding process
