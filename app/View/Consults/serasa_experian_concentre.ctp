<div class="container-fluid">
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<a href="/consultas/serasa-experian/serasa-experian-concentre" class="btn btn-info pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Nova</a>
			<ol class="breadcrumb">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="white-box">
				...
				<h3 class="text-center">CONCENTRE - Consulta CONCENTRE CPF/CNPJ</h3>
				<h5 class="text-center">SERASA Experian</h5>

				<?php if ( empty($result) ) { ?>
				<form method="post" action="/consultas/serasa-experian/serasa-experian-concentre">
					...
					<div class="form-group">
						<div class="checkbox checkbox-success">
							<input id="is_participacoes" type="checkbox" name="data[Consult][is_participacoes]" value="1">
							<label for="is_participacoes">Participações (Custo Adicional: R$6,59)</label>
						</div>
						<div class="checkbox checkbox-success">
							<input id="is_risk_scoring" type="checkbox" name="data[Consult][is_risk_scoring]" value="1">
							<label for="is_risk_scoring">RiskScoring (Custo Adicional: R$9,84)</label>
						</div>
						<div class="checkbox checkbox-success">
							<input id="is_limite_credito" type="checkbox" name="data[Consult][is_limite_credito]" value="1">
							<label for="is_limite_credito">Limite de Crédito (Custo Adicional: R$9,84)</label>
						</div>
					</div>
								...
								<?php if ( !empty($result->Protestos) && $result->Protestos->TotalOcorrencias > 0 ) : ?>
									...
									<?php if ( !empty($result->Protestos->ProtestosDetalhe) && sizeof($result->Protestos->ProtestosDetalhe) > 0 ) : ?>
										...
										<?php $x_protesto=1;foreach ($result->Protestos->ProtestosDetalhe as $protesto) { ?>
											...
											<tr>
												<td class="text-right">Natureza</td>
												<td><?php echo $protesto->Natureza ?></td>
											</tr>
											<tr>
												<td class="text-right">Valor</td>
											...
											<tr>
												<td class="text-right">Data da Carta</td>
												<td><?php echo $protesto->DataCarta ?></td>
											</tr>
											<tr>
												<td class="text-right">Data da Inclusão</td>
												<td><?php echo $protesto->DataHoraInclusao ?></td>
											</tr>
											<tr>
												<td class="text-right">Distribuidor</td>
												<td><?php echo $protesto->Distribuidor ?></td>
											</tr>
											<tr>
												<td class="text-right">Vara</td>
												<td><?php echo $protesto->Vara ?></td>
											</tr>
											<tr>
												<td class="text-right">Processo</td>
												<td><?php echo $protesto->Processo ?></td>
											</tr>
