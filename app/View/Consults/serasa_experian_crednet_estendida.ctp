<div class="container-fluid">
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<a href="/consultas/serasa-experian/serasa-experian-crednet-estendida" class="btn btn-info pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Nova</a>
			<ol class="breadcrumb">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="white-box">
				...
				<h3 class="text-center">CREDNET - ESTENDIDA - Pendências Financeiras + Cartórios Estaduais + Opcionais (Quadro de Socios, Participações, Nível de Risco, Limite de Crédito)</h3>
				<h5 class="text-center">SERASA Experian</h5>

				<?php if ( empty($result) ) { ?>
				<form method="post" action="/consultas/serasa-experian/serasa-experian-crednet-estendida">
					...
					<div class="form-group">
						...
						<select name="data[Consult][UF]" id="state" class="form-control" title="Selecione seu estado" required="" data-error="Este campo é obrigatório">
