		...
		<div class="col-md-12 col-xs-12">
			<div class="white-box">
				<ul class="nav nav-tabs tabs customtab">
					<li class="tab active"><a href="#profile" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">Notificação</span> </a> </li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="profile">
						<div class="row">
							<div class="col-md-3 col-xs-6 b-r"> <strong>Full Name</strong> <br>
								<p class="text-muted"><?php echo h($notification['Notification']['title']); ?></p>
							</div>
							...
							<div class="col-md-3 col-xs-6"> <strong>Created</strong> <br>
								<p class="text-muted"><?php echo $this->Custom->formatDateWithHours($notification['Notification']['created']); ?></p>
							</div>
						</div>
						<hr>
