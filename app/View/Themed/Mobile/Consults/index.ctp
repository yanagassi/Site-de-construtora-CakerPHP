					...
					<div class="sttabs tabs-style-linebox">
						...
						<div class="content-wrap text-center">
							<section id="section-linebox-1" class="content-current">
								<h3>Confirmação de Dados Cadastrais (CDC) - Mobile</h3>
								<p>Veja abaixo as consultas que você pode realizar através deste serviço:</p>

								<div class="table-responsive" style="width:100%;margin:0px auto;float: none;">
										...
										<?php foreach ($result as $item) : ?>
											<?php if ( $item['ConsultCategory']['type'] == 'CDC' ) : ?>
												<tr>
													...
													<td><?php echo "R$ " . $this->Custom->numberFormatToBR($item['ConsultCategory']['value_aveeze']) ?> / Consulta</td>
